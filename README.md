...
```
## The code
with a main ruby in a bin and a lib folder, it's easy to move the code to a futurue gem project.
The main ruby only call the Executor class (Responsible to inject the parser to the main parser).
